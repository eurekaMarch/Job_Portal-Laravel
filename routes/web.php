...
Route::group(['account'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::put('/account/update-profile', [AccountController::class, 'updateProfile'])->name("updateProfile");
        Route::post('/account/update-profile-pic', [AccountController::class, 'updateProfilePic'])->name("updateProfilePic");
    });
});
